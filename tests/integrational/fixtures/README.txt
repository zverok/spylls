...
2007-08-23 nemeth AT OOo

- TRY extended with apostrophe and dash for
 dont -> don't
 alltime -> all-time suggestions
- new REP suggestions:
- REP alot a_lot (alot ->  a lot)  (dictionary is also extended with "a lot"
for suggestion)
- REP nt n't (dont -> don't)
- REP avengence -> a vengeance (dictionary is also extended with "a vengeance")
- REP ninties 1990s
